...
A rede geradora (Generator) recebe um vetor de ruído e a classe como entrada.
A rede discriminadora (Discriminator) avalia a autenticidade das imagens condicionadas à classe.
...
from utils.types import AvailableMetrics, Hyperparams
