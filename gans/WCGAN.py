"""
Wasserstein Conditional GAN with Gradient Penalty (WCGAN-GP) para geração condicional.

A rede geradora (Generator) recebe um vetor de ruído e uma classe como entrada.
A rede discriminadora (Critic) avalia sem sigmoid; treinada N_CRITIC vezes por passo do gerador.

Herda de GAN para compartilhar configuração, loop de treino e lógica de best-model.
"""
...
from gans.GAN import GAN, SHARED_CONFIG
...
class WCGANModel(GAN):
    ...
    def evaluate(self) -> Dict[str, float]:
        ...
        try:
            from utils.eval_images import calculate_fid, calculate_psnr_ssim_lpips
